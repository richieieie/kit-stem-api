...
namespace KSH.Api.Migrations
{
    ...
    [Migration("20241102070248_Change_RefreshToken_ExpirationTime_DataType")]
    partial class Change_RefreshToken_ExpirationTime_DataType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KSH.Api.Models.Domain.Cart", b =>
                {
            ...
            modelBuilder.Entity("KSH.Api.Models.Domain.OrderSupport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KSH.Api.Models.Domain.ShippingFee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KSH.Api.Models.Domain.LabSupport", b =>
                {
                    b.HasOne("KSH.Api.Models.Domain.OrderSupport", "OrderSupport")
            ...
            modelBuilder.Entity("KSH.Api.Models.Domain.Payment", b =>
                {
                    ...
                    b.HasOne("KSH.Api.Models.Domain.UserOrders", "UserOrders")
                        .WithOne("Payment")
                        .HasForeignKey("KSH.Api.Models.Domain.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KSH.Api.Models.Domain.UserOrders", b =>
                {
                    b.HasOne("KSH.Api.Models.Domain.ShippingFee", "ShippingFee")
                        .WithOne()
                        .HasForeignKey("KSH.Api.Models.Domain.UserOrders", "ShippingFeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
